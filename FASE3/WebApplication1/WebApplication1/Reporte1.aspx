...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="jumbotron">
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt" style="font-size: small" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Width="919px">
            <LocalReport DisplayName="Reporte1" ReportEmbeddedResource="WebApplication1.Report4.rdlc" ReportPath="C:\Users\Sergio\Documents\GitHub\IPC2J15\FASE3\WebApplication1\WebApplication1\Report4.rdlc">
                <DataSources>
